      ...
      <table class="genre-table">
        ...
        <tbody>
          ...
          <tr v-for="(genre, index) in genres" :key="genre.id">
            <td>{{ index + 1 }}</td>
            <td class="film-title-cell"><span class="badge badge-regular">{{ genre.nama_genre }}</span></td>
            <td>
...
.genre-table { width: 100%; border-collapse: collapse; }
.genre-table th { background: #1a1a2e; color: white; padding: 14px 16px; text-align: center; font-size: 13px; font-weight: 600; }
.genre-table td { padding: 12px 16px; border-bottom: 1px solid #f0f0f0; font-size: 14px; vertical-align: middle; }
.genre-table tr:last-child td { border-bottom: none; align-items: center; }
.genre-table tr:hover td { background: #fafafa; }
